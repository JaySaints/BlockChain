...
CREATE SCHEMA sch_bkc
GO
-- Cria trabela CORRETORA
CREATE TABLE sch_bkc.Corretora
(
...
(
	...
	FOREIGN KEY (MoedaPrincipal) REFERENCES sch_bkc.Moeda (CodigoMoeda)
)
GO
...
CREATE TABLE sch_bkc.Carteira
(
	Endereco varchar(100) NOT NULL,
	CodigoCorretora int NOT NULL,
	CodigoCliente int NOT NULL,
	PRIMARY KEY (Endereco),
	FOREIGN KEY (CodigoCorretora) REFERENCES sch_bkc.Corretora (CodigoCorretora),
	FOREIGN KEY (CodigoCliente) REFERENCES sch_bkc.Cliente (CodigoCliente)
)
GO
...
CREATE TABLE sch_bkc.ItemCarteira
(
	...
	FOREIGN KEY (Endereco) REFERENCES sch_bkc.Carteira (Endereco),
	FOREIGN KEY (CodigoMoeda) REFERENCES sch_bkc.Moeda (CodigoMoeda)
)
GO
...
CREATE TABLE sch_bkc.ParesMoedas
(
	CodigoMoedaBase varchar(3) NOT NULL,
	CodigoMoedaCotacao varchar(3) NOT NULL,
	Valor float NOT NULL,
	PRIMARY KEY (Valor),
	FOREIGN KEY (CodigoMoedaBase) REFERENCES sch_bkc.Moeda (CodigoMoeda),
	FOREIGN KEY (CodigoMoedaCotacao) REFERENCES sch_bkc.Moeda (CodigoMoeda)
)
